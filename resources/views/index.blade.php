                    ...
                    <div>
                        ...
                        <div class="box">
                            ...
                            <form method="post" action={{ route("cuestionario.guardar") }} enctype="multipart/form-data">
                                ...
                                <h3 class="subtitle has-text-black">Las siguientes preguntas se basan en los riesgos laborales. Por favor, elija las opciones de respuesta más apropiadas. </h3>
                                <div class="field">
                                    <b><p>1- Con qué frecuencia empuja o levanta manualmente artículos que pesen más de 20 kg?</p></b>
                                    <div class="control">
                                          <br>
                                          <input type="radio" name="question1" value=1> <label for="nunca">Nunca</label>
                                          <input type="radio" name="question1" value=2> <label for="unaano">Una vez al año</label>
                                ...
                                <div class="field">
                                    <b><p>2- Con qué frecuencia hace movimientos repetitivos con las manos durante al menos 3 horas durante el día.</p></b>
                                    <div class="control">
                                        <br>
                                          <input type="radio" name="question2" value=1> <label for="nunca">Nunca</label>
                                          <input type="radio" name="question2" value=2> <label for="unaano">Una vez al año</label>
                                ...
                                <div class="field">
                                    <b><p>3- Con qué frecuencia realiza tareas con las que no está familiarizado</p></b>
                                    <div class="control">
                                        <br>
                                          <input type="radio" name="question3" value=1> <label for="nunca">Nunca</label>
                                          <input type="radio" name="question3" value=2> <label for="unaano">Una vez al año</label>
                                ...
                                <div class="field">
                                    <b><p>4- Con qué frecuencia interactua con productos químicos o sustancias inflamables.</p></b>
                                    <div class="control">
                                        <br>
                                          <input type="radio" name="question4" value=1> <label for="nunca">Nunca</label>
                                          <input type="radio" name="question4" value=2> <label for="unaano">Una vez al año</label>
                                ...
                                <div class="field">
                                    <b><p>5- Con qué frecuencia trabaja en posiciones incómodas (doblar, torcer, trabajo manual pesado)</p></b>
                                    <div class="control">
                                        <br>
                                          <input type="radio" name="question5" value=1> <label for="nunca">Nunca</label>
                                          <input type="radio" name="question5" value=2> <label for="unaano">Una vez al año</label>
                                ...
                                <div class="field">
                                    <b><p>6- Con qué trabaja a una altura de más de 5 metros.</p></b>
                                    <div class="control">
                                        <br>
                                          <input type="radio" name="question6" value=1> <label for="nunca">Nunca</label>
                                          <input type="radio" name="question6" value=2> <label for="unaano">Una vez al año</label>
                                ...
                                <div class="field">
                                    <b><p>7- Con qué trabaja trabaja en altos niveles de decibelios</p></b>
                                    <div class="control">
                                        <br>
                                          <input type="radio" name="question7" value=1> <label for="nunca">Nunca</label>
                                          <input type="radio" name="question7" value=2> <label for="unaano">Una vez al año</label>
                                ...
                                <div class="field">
                                    <b><p>8- Con qué se queda de pie por más de 3 horas al día.</p></b>
                                    <div class="control">
                                        <br>
                                          <input type="radio" name="question8" value=1> <label for="nunca">Nunca</label>
                                          <input type="radio" name="question8" value=2> <label for="unaano">Una vez al año</label>
